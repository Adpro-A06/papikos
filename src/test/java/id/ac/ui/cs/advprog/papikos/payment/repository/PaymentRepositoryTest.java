...
public class PaymentRepositoryTest {
    ...
    void shouldSaveValidPayment() {
        ...
        Payment payment = new Payment(id, fromUserId, toUserId,
                new BigDecimal("100000"), TransactionType.PAYMENT, LocalDateTime.now());
    ...
    void shouldSaveMultiplePayments() {
        repository.save(new Payment(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), new BigDecimal("50000"), TransactionType.PAYMENT, LocalDateTime.now()));
        repository.save(new Payment(UUID.randomUUID(), UUID.randomUUID(), UUID.randomUUID(), new BigDecimal("60000"), TransactionType.TOPUP, LocalDateTime.now()));
    ...
    void shouldReturnPaymentsForGivenUser() {
        ...
        repository.save(new Payment(UUID.randomUUID(), user1, UUID.randomUUID(), new BigDecimal("70000"), TransactionType.PAYMENT, LocalDateTime.now()));
        repository.save(new Payment(UUID.randomUUID(), user2, UUID.randomUUID(), new BigDecimal("80000"), TransactionType.PAYMENT, LocalDateTime.now()));
    ...
    void shouldThrowExceptionWhenSavingDuplicateId() {
        UUID id = UUID.randomUUID();
        Payment p1 = new Payment(id, UUID.randomUUID(), UUID.randomUUID(), new BigDecimal("50000"), TransactionType.PAYMENT, LocalDateTime.now());
        Payment p2 = new Payment(id, UUID.randomUUID(), UUID.randomUUID(), new BigDecimal("60000"), TransactionType.TOPUP, LocalDateTime.now());
