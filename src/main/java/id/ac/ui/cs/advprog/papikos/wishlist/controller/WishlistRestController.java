...
public class WishlistRestController {
   ...
   public ResponseEntity<?> addToWishlist(
       ...
       try {
           ...
           // Convert to String for Wishlist constructor
           String userId = user.getId().toString();
           String kosIdStr = kosId.toString();
           Wishlist wishlist = new Wishlist(userId, kosIdStr);
   ...
   public ResponseEntity<?> removeFromWishlist(
       ...
       try {
           ...
           if (removed) {
               ...
               String userId = user.getId().toString();
               String kosIdStr = kosId.toString();
               Wishlist removedWishlist = new Wishlist(userId, kosIdStr);
   ...
   public ResponseEntity<?> toggleWishlist(
       ...
       try {
           ...
           if (inWishlist) {
               ...
               wishlistSubject.notifyObservers(new Wishlist(userId, kosIdStr), "removed");
   ...
   public ResponseEntity<?> clearWishlist(@RequestHeader("Authorization") String authHeader) {
       try {
           ...
           // Convert to String for Wishlist constructor
           String userId = user.getId().toString();
           Wishlist clearedWishlist = new Wishlist(userId, null);
